<tbody class="bg-white">
    @for ($i = 0; $i < $products->count(); $i++)
        ...
        <tr class="group">
            ...
            <x-tabel.td :value="$products[$i]->nama" :route="'rincian-dokumen'" :id="'2'" />
            <x-tabel.td :value="$total->amount ?? 0" :route="'rincian-dokumen'" :id="'2'" />
            <x-tabel.td :value="$products[$i]->price" :route="'rincian-dokumen'" :id="'2'" :money="true" />
            <x-tabel.td :value="__($products[$i]->discount . '%')" :route="'rincian-dokumen'" :id="'2'" />
            <td {{-- HACK: coba cek apakah  bisa dijadikan component daripada diluar sendiri --}}
                ...
                <div class="flex">
                    ...
                    <form action="/dokumen/hapus/{{ $products[$i]['id'] }}" method="POST" class="inline item">
