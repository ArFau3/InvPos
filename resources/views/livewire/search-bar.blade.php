<div class="flex">
    ...
    <div class="rounded w-full sm:w-64 border px-1 antialiased">
        {{-- <form action="" wire.submit.prevent class="flex h-full justify-between"> --}}
    ...
    @if ($search)
        ...
        <button {{-- FIXME: di profil lulusan etc jika pemetaan banyak dan height naik untk scroll, tombol x msih kecil dan nda rapi --}} wire:loading.remove wire:click='resetSearch'
